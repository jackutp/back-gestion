...
public class ArticuloKBSController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponseDTO<List<ArticuloKBSDTO>>> listarTodos() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<ArticuloKBSDTO>> obtenerPorId(@PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<ApiResponseDTO<ArticuloKBSDTO>> crear(@Valid @RequestBody CrearArticuloDTO dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<ArticuloKBSDTO>> actualizar(@PathVariable Long id, @Valid @RequestBody CrearArticuloDTO dto) {
    ...
    public ResponseEntity<ApiResponseDTO<ArticuloKBSDTO>> cambiarEstado(@PathVariable Long id, @RequestParam EstadoArticulo estado) {
    ...
    public ResponseEntity<ApiResponseDTO<ArticuloKBSDTO>> votar(@PathVariable Long id, @RequestParam String tipo) {
    ...
    @GetMapping("/resumen")
    public ResponseEntity<ApiResponseDTO<ResumenKBSDTO>> obtenerResumen() {
